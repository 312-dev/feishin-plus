        ...
        <div className={styles.host}>
            ...
            >
                <div className={styles.stage} id={VIDEO_FULLSCREEN_TARGET_ID}>
                    ...
                    >
                        {/*
                         * `crossOrigin` because the cache scheme is registered CORS-enabled:
                         * Chromium applies CORS to requests on it, and a media element that
                         * has not opted in issues a no-cors request that is refused outright.
                         * That surfaced as every candidate erroring a couple of milliseconds
                         * after its source was set, while the still-image probe - which does
                         * opt in - read the same files without trouble.
                         */}
                        <video
