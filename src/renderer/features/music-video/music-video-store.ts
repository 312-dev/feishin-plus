...
export interface MusicVideoMatch {
    ...
    /**
     * How many candidates the original search produced. Kept so a retry can say which attempt it
     * is out of the whole list rather than out of what is left, which counted every attempt as the
     * first and made the total shrink.
     */
